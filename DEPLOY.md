...
デプロイ完了後、以下のファイルの `trillion-ai-juku.com` を実URLに置換:
...
- [ ] `https://trillion-ai-juku.com/lp.html` が閲覧可能
- [ ] `https://trillion-ai-juku.com/` で LPにリダイレクト
- [ ] SSL証明書が緑色
