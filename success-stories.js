...
(function () {
  ...
  const SEED_STORIES = [
    ...
    },
    {
      ...
      story: '現役時代は東北大に2点足らず不合格。1年間予備校に通いながら、AIコーチングは弱点補強用に併用しました。「躓きセンサー」が三角関数の盲点を指摘してくれて、夏前に基礎をやり直したのが転機でした。',
    ...
    },
    {
      ...
      story: '中学3年から英語に注力していたので英語は得意でしたが、数学が伸び悩んでいました。AIコーチングの適応難易度機能で、自分のレベルにピッタリ合った問題を解き続けられたのが良かったです。',
    ...
    },
    {
      ...
      story: 'もともと公募推薦で滑り止めを確保した上で、一般入試で同志社に挑戦。AIコーチングの過去問類題生成で同志社の出題傾向に合わせた演習ができ、本番で得意な世界史を9割取れました。',
    ...
    },
    {
      ...
      story: '部活引退後の高3夏から本格的に受験勉強開始。短期間だったので「何をやらないか」を決めるのに苦労しましたが、AIコーチングの苦手分析で勉強の優先順位を立てられたのが助かりました。',
