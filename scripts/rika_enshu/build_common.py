...
def xy_graph(points, xlab, ylab, xmax, ymax, xstep, ystep, w=230, h=150, line=True, unit=""):
    ...
    s.append(f'<text x="{L-3}" y="{T-4}" class="ax r">{esc(ylab)}</text>')
    if unit:
...
.genko { display:grid; gap:0; margin:5px 0 2px 12px; width:calc(100% - 12px); max-width:560px;
