...
/* questions */
.qsec { margin-top:10px; }
.qtitle { font-size:12pt; font-weight:700; text-align:center; letter-spacing:.5em; padding:3px 0;
  border-top:2px solid #0f172a; border-bottom:2px solid #0f172a; margin-bottom:8px; }
...
.q .choices div { margin:1px 0 1px 6px; font-size:9.7pt; }
...
.foot { text-align:center; color:#64748b; font-size:8.3pt; line-height:1.35; margin-top:4px; padding-top:3px; border-top:1px solid #e2e8f0;
...
def svg_fig1():
    ...
    <text x="80" y="103" fill="#fff" font-size="15" font-weight="700" text-anchor="middle">大きな目標</text>
    <text x="80" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">a large goal</text>
    ...
    <text x="347" y="42" fill="#b91c1c" font-size="12" font-weight="700" text-anchor="middle">大きな決意・一気の努力</text>
    <text x="347" y="60" fill="#7f1d1d" font-size="10" text-anchor="middle">完璧な月曜日を待つ（第1段）</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">小さな習慣（1日5分）</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">ハードルが低い・毎日できる（第3段）</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">つらい一日で鎖が切れる</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">break the chain（第6段）</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">毎日続き、1年後に大差</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">30時間超の積み重ね（第4段）</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">小さな習慣の力</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">why small habits work</text>
    ...
    <text x="335" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 積み重ね</text>
    <text x="335" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">add up（第4段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 失敗しにくさ</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">hard to fail（第5段）</text>
    ...
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">1日5分→1年で30時間超の差に</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">thirty hours of steady practice（第4段）</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">続いた証拠→自信→さらに継続</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">evidence → confidence（第5段）</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="82" fill="#b91c1c" font-size="14" font-weight="700" text-anchor="middle">挫折 ＝ 意志が弱いから？</text>
    <text x="130" y="104" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ 意志の力の欠如が原因</text>
    ...
    <text x="510" y="70" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">真因 ＝ 最初の一歩が大きすぎること</text>
    <text x="510" y="92" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 目標は大きく、入口は小さく——入口を「5分の扉」にする</text>
    <text x="510" y="112" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not a lack of willpower but a first step that is too big</text>
    <text x="510" y="130" fill="#64748b" font-size="9" text-anchor="middle">夢を縮めるのではない——毎日開けられる扉が、決意より遠くへ運ぶ（第7段）</text>
  </svg>"""
