...
def svg_fig1():
    ...
    <text x="80" y="103" fill="#fff" font-size="15" font-weight="700" text-anchor="middle">外国語</text>
    <text x="80" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">a foreign language</text>
    ...
    <text x="347" y="42" fill="#b91c1c" font-size="12" font-weight="700" text-anchor="middle">機械に翻訳させる</text>
    <text x="347" y="60" fill="#7f1d1d" font-size="10" text-anchor="middle">速く・安く・正確（実用場面）</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">自分で学ぶ</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">時間と苦労をかける</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">情報だけが届く</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">伝達はそこで終わる</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">視点と関係が育つ</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">新しい目・敬意・相対化</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">学習が与えるもの</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">why learn?</text>
    ...
    <text x="335" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 世界の切り取り方</text>
    <text x="335" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">way of noticing（第4段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 学ぶ過程そのもの</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">the process itself（第5段）</text>
    ...
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">新しい視点——新しい目で世界を見る</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">a new pair of eyes</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">敬意が伝わり、母語を外から眺める</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">respect ＋ a new standpoint</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="82" fill="#b91c1c" font-size="14" font-weight="700" text-anchor="middle">学習 ＝ 時間の無駄？</text>
    <text x="130" y="104" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ 機械が訳してくれるから</text>
    ...
    <text x="510" y="70" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">翻訳＝情報 ／ 学習＝視点と関係</text>
    <text x="510" y="92" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 学ぶ理由は〈情報伝達の外〉にある</text>
    <text x="510" y="112" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not so much information as a new pair of eyes</text>
    <text x="510" y="130" fill="#64748b" font-size="9" text-anchor="middle">機械は道具として使いつつ——学ぶ理由はむしろ増えた</text>
  </svg>"""
