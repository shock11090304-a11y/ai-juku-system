...
def svg_fig1():
    ...
    <text x="85" y="103" fill="#fff" font-size="15" font-weight="700" text-anchor="middle">一枚の地図</text>
    <text x="85" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">a map</text>
    ...
    <text x="347" y="42" fill="#334155" font-size="12" font-weight="700" text-anchor="middle">〈写真〉という前提</text>
    <text x="347" y="60" fill="#475569" font-size="10" text-anchor="middle">ありのままの記録・地理は決着済み（第1段）</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">〈主張〉という見方</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">選択の産物・巧拙がある（第6段）</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">そのまま受け取る</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">判断を写真として受け取る</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">用途で評価する</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">何のために作られたかを問う（第7段）</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">選択が入る場所</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">where choice enters</text>
    ...
    <text x="335" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 投影 projection</text>
    <text x="335" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">球は平面化で必ず歪む（第3段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 取捨 selection</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">何に線を与えるか（第4段）</text>
    ...
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">方位を守れば極が膨らむ</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">pays for that fidelity（第3段）</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">鉄道は載り、小道は消える</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">告げられない＝強力（第4段）</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="70" fill="#b91c1c" font-size="12.5" font-weight="700" text-anchor="middle">「地図は嘘をつく」？</text>
    <text x="130" y="90" fill="#7f1d1d" font-size="10" text-anchor="middle">✗ 欺きでもなく</text>
    <text x="130" y="107" fill="#7f1d1d" font-size="10" text-anchor="middle">✗ どれも同じでもない</text>
    ...
    <text x="510" y="68" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">写真ではなく「主張」である</text>
    <text x="510" y="90" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 主張だから、うまくも まずくも なされうる</text>
    <text x="510" y="110" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not a photograph of the world but an argument about it</text>
    <text x="360" y="148" fill="#64748b" font-size="9" text-anchor="middle">評価軸：選択の有無ではなく、その選択が用途にかなうか（第6段）</text>
  </svg>"""
