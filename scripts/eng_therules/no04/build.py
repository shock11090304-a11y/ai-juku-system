...
def build_mondai():
    ...
    h += '</div>'
    h += foot("問題編")
    return doc("英語長文 The Rules 式 No.04 問題編", h)
...
def svg_fig1():
    ...
    <text x="85" y="103" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">学んだ内容</text>
    <text x="85" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">new material</text>
    ...
    <text x="347" y="42" fill="#b91c1c" font-size="12" font-weight="700" text-anchor="middle">徹夜で詰め込む</text>
    <text x="347" y="60" fill="#7f1d1d" font-size="10" text-anchor="middle">「時間を稼いだ」つもり</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">学んでから眠る</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">夜の脳に整理を任せる</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">多くが漏れ出す</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">leaked away（翌日残らない）</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">長期記憶に定着</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">翌日よく覚えている</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">夜の脳の仕事</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">the services</text>
    ...
    <text x="335" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 記憶の整理・選別</text>
    <text x="335" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">sort through（第3〜4段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 心身のメンテナンス</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">attention &amp; emotions（第5段）</text>
    ...
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">重要なものが長期記憶へ定着する</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">a place in long-term memory</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">集中が戻り、感情が鎮まる</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">attention ＝ 学びの「門」</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="82" fill="#b91c1c" font-size="14" font-weight="700" text-anchor="middle">睡眠 ＝ 時間の無駄？</text>
    <text x="130" y="104" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ 何も起きていない空白</text>
    ...
    <text x="510" y="70" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">睡眠 ＝ 投資（脳への支払い）</text>
    <text x="510" y="92" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 今日の努力を明日の能力に変える時間</text>
    <text x="510" y="112" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not lost time but a form of investment</text>
    <text x="510" y="130" fill="#64748b" font-size="9" text-anchor="middle">問い直すべきは「眠りを削る勇気」への称賛そのもの</text>
  </svg>"""
...
def build_kaisetsu():
    ...
    return doc("英語長文 The Rules 式 No.04 解説編", h)
