...
def build_mondai():
    ...
    h += '</div>'
    h += foot("問題編")
    return doc("英語長文 The Rules 式 No.07 問題編", h)
...
def svg_fig1():
    ...
    <text x="85" y="103" fill="#fff" font-size="15" font-weight="700" text-anchor="middle">手の「遅さ」</text>
    <text x="85" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">the slowness of the hand</text>
    <path d="M150 96 L250 46" stroke="#64748b" stroke-width="2.5" fill="none" marker-end="url(#ar)"/>
    ...
    <text x="347" y="42" fill="#334155" font-size="12" font-weight="700" text-anchor="middle">〈弱点〉という通念</text>
    <text x="347" y="60" fill="#475569" font-size="10" text-anchor="middle">遅い・時代遅れの習慣（第1段）</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">〈仕組み〉という主張</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">選ぶことを強いる装置（第3段）</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">機械に置き換える</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">全文を複製できるが考えない</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">理解のために使う</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">短いノート＝考えた証（第7段）</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">二つのノート</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">typing vs writing</text>
    <path d="M170 98 L245 44" stroke="#64748b" stroke-width="2.5" fill="none" marker-end="url(#g2)"/>
    ...
    <rect x="250" y="16" width="170" height="52" rx="9" fill="#f8fafc" stroke="#94a3b8"/>
    <text x="335" y="37" fill="#475569" font-size="12" font-weight="700" text-anchor="middle">打つ（キーボード）</text>
    <text x="335" y="55" fill="#64748b" font-size="9.5" text-anchor="middle">速い・きれい・検索できる（第2段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">書く（ペン）</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">遅い・短い・選ぶ（第3段）</text>
    <path d="M420 42 L470 42" stroke="#94a3b8" stroke-width="2" fill="none" marker-end="url(#g2)"/>
    <path d="M420 172 L470 172" stroke="#94a3b8" stroke-width="2" fill="none" marker-end="url(#b2)"/>
    <rect x="475" y="18" width="225" height="48" rx="9" fill="#f8fafc" stroke="#cbd5e1"/>
    <text x="587" y="38" fill="#475569" font-size="11" font-weight="700" text-anchor="middle">教師の文をそのまま複製</text>
    <text x="587" y="55" fill="#64748b" font-size="9.5" text-anchor="middle">word for word（第4段）</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">自分の言葉で組み直す</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">「なぜ」を問う問題で差（第4段）</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="76" fill="#b91c1c" font-size="13" font-weight="700" text-anchor="middle">ペンに魔法がある？</text>
    <text x="130" y="98" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ 考えずに写すなら得るものはない</text>
    ...
    <text x="510" y="68" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">価値は「道具が強いる作業」に</text>
    <text x="510" y="90" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 遅さが選択と再構成を強いる＝それが思考</text>
    <text x="510" y="110" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not in the tool but in the work</text>
    <text x="360" y="148" fill="#64748b" font-size="9" text-anchor="middle">だから使い分け：保存・検索・送信は機械、理解は手（第7段）</text>
  </svg>"""
...
def build_kaisetsu():
    ...
    return doc("英語長文 The Rules 式 No.07 解説編", h)
