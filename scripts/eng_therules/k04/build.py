...
def svg_fig1():
    ...
    <text x="85" y="103" fill="#fff" font-size="15" font-weight="700" text-anchor="middle">まちがい</text>
    <text x="85" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">mistakes</text>
    ...
    <text x="347" y="42" fill="#334155" font-size="12" font-weight="700" text-anchor="middle">本番のテスト</text>
    <text x="347" y="60" fill="#475569" font-size="10" text-anchor="middle">ミスが少ないほど高得点（第2段）</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">練習の段階</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">まちがえた瞬間に脳が学ぶ（第3段）</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">力を「示す」場</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">慎重な解答が点を守る</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">自分を「つくる」場</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">挑戦と訂正が力を伸ばす（第4段）</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">まちがい＝学び</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">why mistakes teach us</text>
    ...
    <text x="335" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 記憶に残る</text>
    <text x="335" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">recall → miss → check（第4段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 挑戦が続く</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">no fear → try hard ones（第5段）</text>
    ...
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">ただ読み直すより強く覚えられる</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">stays in memory better（第4段）</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">難しい問題に挑み、伸びが止まらない</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">恐れると易しい問題だけ→伸び停止（第5段）</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="76" fill="#b91c1c" font-size="13" font-weight="700" text-anchor="middle">まちがい ＝ 弱さの証拠？</text>
    <text x="130" y="98" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ 恥ずかしいから隠す・消す</text>
    ...
    <text x="510" y="68" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">まちがい ＝ 学びが起きている印</text>
    <text x="510" y="90" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 能力の際で挑んでいる証拠——原因を考え、次の一歩の材料にする</text>
    <text x="510" y="110" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not proof of weakness but a sign that learning is happening</text>
    <text x="360" y="148" fill="#64748b" font-size="9" text-anchor="middle">前提：本番の試験でわざと間違えろという話ではない——変えるのは練習での扱い方（第7段）</text>
  </svg>"""
