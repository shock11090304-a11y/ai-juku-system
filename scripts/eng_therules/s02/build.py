...
def build_mondai():
    ...
    h += '</div>'
    h += foot("問題編")
    return doc("英語長文 The Rules 式 No.02 問題編", h)

# ---------------- 図解 SVG ----------------
def svg_fig1():
    return """<svg viewBox="0 0 720 210" xmlns="http://www.w3.org/2000/svg" font-family="'Hiragino Kaku Gothic ProN',sans-serif">
    <rect x="15" y="82" width="145" height="46" rx="9" fill="#334155"/>
    <text x="87" y="103" fill="#fff" font-size="13.5" font-weight="700" text-anchor="middle">科学への二つの見方</text>
    <text x="87" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">two views of science</text>
    <path d="M160 96 L250 46" stroke="#64748b" stroke-width="2.5" fill="none" marker-end="url(#ar)"/>
    <path d="M160 114 L250 164" stroke="#1d4ed8" stroke-width="2.5" fill="none" marker-end="url(#ab)"/>
    <defs>
    ...
    <text x="347" y="42" fill="#334155" font-size="12" font-weight="700" text-anchor="middle">確実な答えの倉庫（通念）</text>
    <text x="347" y="60" fill="#475569" font-size="10" text-anchor="middle">完成した真理の集積（第1段）</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">仮説を更新する方法（実像）</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">誤りうる仮説×証拠の検証（第3段）</text>
    ...
    <rect x="525" y="24" width="180" height="48" rx="9" fill="#f8fafc" stroke="#94a3b8"/>
    <text x="615" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">意見が変わる＝失敗の印</text>
    <text x="615" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">信頼が下がる（第1段）</text>
    <rect x="525" y="140" width="180" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="615" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">意見が変わる＝正常動作</text>
    <text x="615" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">方法が機能している印（第4段）</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">科学が与えるもの</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">what science offers</text>
    ...
    <text x="335" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 確率</text>
    <text x="335" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">probabilities（第5段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 暫定的な最良の説明</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">provisional best explanations</text>
    ...
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">断定ではなく「どの程度確からしいか」</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">not certainty but likelihood（第5段）</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">よりよい説明が現れるまで有効</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">until something better survives（第5段）</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="76" fill="#b91c1c" font-size="13" font-weight="700" text-anchor="middle">不確実性 ＝ 科学の弱点？</text>
    <text x="130" y="98" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ 意見が変わるのは不信の証拠</text>
    ...
    <text x="510" y="68" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">不確実性 ＝ 科学を科学たらしめる条件</text>
    <text x="510" y="90" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 権威ではなく証拠が最終決定権を持つ仕組みの代価</text>
    <text x="510" y="110" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not a weakness but the very condition that makes science science</text>
    <text x="360" y="148" fill="#64748b" font-size="9" text-anchor="middle">前提：すべてが等しく暫定的なわけではない——証拠の重みに応じて信頼にも差をつける（第7段）</text>
  </svg>"""
...
def build_kaisetsu():
    ...
    return doc("英語長文 The Rules 式 No.02 解説編", h)
