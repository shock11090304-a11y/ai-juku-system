...
.secttl { font-size:13pt; font-weight:700; color:#0f172a; border-left:6px solid #1e3a8a;
  padding:3px 0 3px 10px; margin:0 0 10px; }
...
def build_mondai():
    ...
    h += '</div>'
    h += foot("問題編")
    return doc("英語長文 The Rules 式 No.03 問題編", h)

# ---------------- 図解 SVG ----------------
def svg_fig1():
    return """<svg viewBox="0 0 720 210" xmlns="http://www.w3.org/2000/svg" font-family="'Hiragino Kaku Gothic ProN',sans-serif">
    <rect x="20" y="82" width="120" height="46" rx="9" fill="#334155"/>
    <text x="80" y="103" fill="#fff" font-size="15" font-weight="700" text-anchor="middle">都市の緑</text>
    <text x="80" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">urban nature</text>
    <path d="M140 96 L250 46" stroke="#dc2626" stroke-width="2.5" fill="none" marker-end="url(#ar)"/>
    <path d="M140 114 L250 164" stroke="#1d4ed8" stroke-width="2.5" fill="none" marker-end="url(#ab)"/>
    <defs>
    ...
    <text x="347" y="42" fill="#b91c1c" font-size="12" font-weight="700" text-anchor="middle">「飾り」とみなす</text>
    <text x="347" y="60" fill="#7f1d1d" font-size="10" text-anchor="middle">あれば嬉しいおまけ扱い</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">「必需」とみなす</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">インフラとして維持する</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">真っ先に削られる</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">あとで損失の代償を払う</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">都市を支え続ける</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">健康・涼しさ・治水</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">都市の緑の働き</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">green space</text>
    ...
    <rect x="250" y="16" width="165" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="332" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 人を支える</text>
    <text x="332" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">注意の回復・ストレス減（第3段）</text>
    <rect x="250" y="146" width="165" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="332" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 都市を支える</text>
    <text x="332" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">木陰・蒸散・雨水吸収（第4段）</text>
    <path d="M415 42 L470 42" stroke="#94a3b8" stroke-width="2" fill="none" marker-end="url(#g2)"/>
    <path d="M415 172 L470 172" stroke="#94a3b8" stroke-width="2" fill="none" marker-end="url(#g2)"/>
    <rect x="475" y="18" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">医療への負担が軽くなる</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">a lighter burden（第5段）</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">冷房費と水害の費用が減る</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">closer to saving（第5段）</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="82" fill="#b91c1c" font-size="14" font-weight="700" text-anchor="middle">緑 ＝ 飾り？</text>
    <text x="130" y="104" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ あれば嬉しいおまけ</text>
    ...
    <text x="510" y="70" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">緑 ＝ 都市を支える「インフラ」</text>
    <text x="510" y="92" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 道路・水道と同列の「必需」</text>
    <text x="510" y="112" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not decoration but a kind of infrastructure</text>
    <text x="510" y="130" fill="#64748b" font-size="9" text-anchor="middle">問うべきは「余裕があるか」でなく「何を必需とみなすか」</text>
  </svg>"""
...
def build_kaisetsu():
    ...
    # --- 全訳 ---
    h += '<div class="section"><div class="secttl">全訳<span class="en2">Translation</span></div>'
    for n, t in C.TRANSLATION:
        h += f'<div class="tr"><div class="num">{n}</div><div class="t">{t}</div></div>'
    h += '</div>'
    ...
    return doc("英語長文 The Rules 式 No.03 解説編", h)
