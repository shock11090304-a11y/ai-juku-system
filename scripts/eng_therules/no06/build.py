...
def build_mondai():
    ...
    h += '</div>'
    h += foot("問題編")
    return doc("英語長文 The Rules 式 No.06 問題編", h)
...
def svg_fig1():
    ...
    <text x="80" y="103" fill="#fff" font-size="15" font-weight="700" text-anchor="middle">チーム作り</text>
    <text x="80" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">building a team</text>
    ...
    <text x="347" y="42" fill="#b91c1c" font-size="12" font-weight="700" text-anchor="middle">気の合う同質チーム</text>
    <text x="347" y="60" fill="#7f1d1d" font-size="10" text-anchor="middle">速い・快適・自信満々（第2段）</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">背景の異なる多様チーム</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">議論は長く・自信は控えめ</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">しばしば誤る</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">誰も前提を疑わない</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">結論はより正確</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">盲点が表に出て消える</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">多様性の働き</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">why diversity works</text>
    ...
    <text x="335" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 視点の衝突</text>
    <text x="335" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">a clash of viewpoints（第3段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 少数派の声</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">a minority voice（第5段）</text>
    ...
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">「当たり前」を疑わせ、盲点を消す</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">blind spots erased（第3〜4段）</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">多数派が根拠の点検を始める</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">checking their evidence（第5段）</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="82" fill="#b91c1c" font-size="14" font-weight="700" text-anchor="middle">居心地の悪さ ＝ 代償？</text>
    <text x="130" y="104" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ 公平さのために払うコスト</text>
    ...
    <text x="510" y="70" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">多様性 ＝ 思考の道具箱の違い</text>
    <text x="510" y="92" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 居心地の悪さこそ、チームを賢くする〈機能〉</text>
    <text x="510" y="112" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not a price but the very feature</text>
    <text x="510" y="130" fill="#64748b" font-size="9" text-anchor="middle">前提：共通の目的と互いへの敬意——壊れずに意見をぶつけ合える成熟</text>
  </svg>"""
...
def build_kaisetsu():
    ...
    return doc("英語長文 The Rules 式 No.06 解説編", h)
