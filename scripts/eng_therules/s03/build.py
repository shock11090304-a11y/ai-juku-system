...
def svg_fig1():
    ...
    <rect x="20" y="82" width="150" height="46" rx="9" fill="#334155"/>
    <text x="95" y="103" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">プライバシーとは？</text>
    <text x="95" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">two views of privacy</text>
    <path d="M170 96 L245 46" stroke="#64748b" stroke-width="2.5" fill="none" marker-end="url(#ar)"/>
    <path d="M170 114 L245 164" stroke="#1d4ed8" stroke-width="2.5" fill="none" marker-end="url(#ab)"/>
    <defs>
    ...
    <rect x="250" y="22" width="200" height="52" rx="9" fill="#f8fafc" stroke="#64748b"/>
    <text x="350" y="42" fill="#334155" font-size="12" font-weight="700" text-anchor="middle">通念：やましい者の隠れ蓑</text>
    <text x="350" y="60" fill="#475569" font-size="10" text-anchor="middle">It is often said …＝他人の声（第1段）</text>
    <rect x="250" y="138" width="200" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="350" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">筆者：自己形成の条件</text>
    <text x="350" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">Nonetheless の後＝筆者側（第1・3段）</text>
    <path d="M450 48 L520 48" stroke="#94a3b8" stroke-width="2" fill="none" marker-end="url(#ag)"/>
    <path d="M450 164 L520 164" stroke="#94a3b8" stroke-width="2" fill="none" marker-end="url(#ag)"/>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">正直者なら手放せる</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">安全・利便と交換できる贅沢品</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">誰にとっても必要</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">秘密でなく「余白」を守る（第6段）</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">監視の内面化</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">the gaze internalized</text>
    ...
    <text x="335" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 前もって自己検閲</text>
    <text x="335" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">edit ourselves in advance（第4段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 無難な意見だけ残る</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">ideas go unspoken（第5段）</text>
    ...
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">試行錯誤の放棄——考えを試せない</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">tested, revised, reversed（第4段）</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">思考の多様性＝共有資源の喪失</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">訂正・改革・進歩の土台（第5段）</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="76" fill="#b91c1c" font-size="13" font-weight="700" text-anchor="middle">プライバシー ＝ 壁？</text>
    <text x="130" y="98" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ やましい秘密を隠す衝立</text>
    ...
    <text x="510" y="68" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">プライバシー ＝ 自分になるための余白</text>
    <text x="510" y="90" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 考えを試し、疑いを抱き、脆い意見を育てる空間（第6段）</text>
    <text x="510" y="110" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not a wall to hide behind but a margin to become who we are</text>
    <text x="360" y="148" fill="#64748b" font-size="9" text-anchor="middle">前提：情報共有をやめよという話ではない——問いは「誰が・何のために・どこまで見るのか」（第7段）</text>
  </svg>"""
