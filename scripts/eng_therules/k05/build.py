...
def svg_fig1():
    ...
    <text x="85" y="103" fill="#fff" font-size="15" font-weight="700" text-anchor="middle">教える時間</text>
    <text x="85" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">time to teach a friend</text>
    ...
    <text x="347" y="42" fill="#334155" font-size="12" font-weight="700" text-anchor="middle">見方①：勉強の損</text>
    <text x="347" y="60" fill="#475569" font-size="10" text-anchor="middle">自分の時間が奪われる（第1段）</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">見方②：二度目の学び</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">説明＝理解のテスト（第3段）</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">「わかったつもり」のまま</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">理解の穴に気づけない</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">穴が見つかり記憶も深まる</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">テスト・地図・深い記憶（第7段）</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">教えることの働き</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">what teaching does</text>
    ...
    <text x="335" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 理解のテスト</text>
    <text x="335" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">説明で詰まる＝穴の発見（第3〜4段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 教えるつもり効果</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">頭が情報を整理し始める（第5段）</text>
    ...
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">弱点の地図が手に入る</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">a map of your own weakness（第4段）</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">深く順序立った記憶に残る</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">a deeper, more ordered form（第5段）</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="76" fill="#b91c1c" font-size="13" font-weight="700" text-anchor="middle">教える ＝ 時間の損？</text>
    <text x="130" y="98" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ 一方的な親切にすぎない</text>
    ...
    <text x="510" y="68" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">教える ＝ 自分の二度目の学び</text>
    <text x="510" y="90" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 一度目＝内容に出会うとき／二度目＝自分のことばで組み立て直すとき</text>
    <text x="510" y="110" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not a one-way favor but a second chance to learn</text>
    <text x="360" y="148" fill="#64748b" font-size="9" text-anchor="middle">前提：勉強を全部後回しにせよという話ではない——5分の説明が二人の最良の近道になる（第7段）</text>
  </svg>"""
