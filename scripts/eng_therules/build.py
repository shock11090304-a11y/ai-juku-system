...
<div class="subline">
  ...
  <span>{C.META['theme_en']}／ 語数 約{WORDS_ROUND} words ・ 目標 {C.META['minutes']}分</span>
</div>"""
...
def svg_fig1():
    ...
    <text x="80" y="103" fill="#fff" font-size="15" font-weight="700" text-anchor="middle">退屈</text>
    <text x="80" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">an empty moment</text>
    ...
    <text x="347" y="42" fill="#b91c1c" font-size="12" font-weight="700" text-anchor="middle">即座に埋める</text>
    <text x="347" y="60" fill="#7f1d1d" font-size="10" text-anchor="middle">スマホ・刺激で穴埋め</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">そのまま留まる</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">退屈に耐える</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">働きが失われる</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">創造も気づきも生まれない</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">創造・気づき</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">さまよい／信号が働く</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">退屈の働き</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">its work</text>
    ...
    <rect x="250" y="16" width="150" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="325" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 心のさまよい</text>
    <text x="325" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">mind-wandering（第3〜4段）</text>
    <rect x="250" y="146" width="150" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="325" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 信号</text>
    <text x="325" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">a messenger（第5段）</text>
    <path d="M400 42 L470 42" stroke="#94a3b8" stroke-width="2" fill="none" marker-end="url(#g2)"/>
    <path d="M400 172 L470 172" stroke="#94a3b8" stroke-width="2" fill="none" marker-end="url(#g2)"/>
    <rect x="475" y="18" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">集中では見逃す結びつき→創造</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">creative leaps</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">「今は無意味」と知らせ意味を探させる</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">seek what matters</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="82" fill="#b91c1c" font-size="14" font-weight="700" text-anchor="middle">退屈 ＝ 敵？</text>
    <text x="130" y="104" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ なくすべきもの</text>
    ...
    <text x="510" y="70" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">退屈 ＝ 使い方を忘れた「道具」</text>
    <text x="510" y="92" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 問題は退屈でなく〈反応の仕方〉</text>
    <text x="510" y="112" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not boredom itself but the way we respond</text>
    <text x="510" y="130" fill="#64748b" font-size="9" text-anchor="middle">なくすものではなく、使い方を思い出すもの</text>
  </svg>"""
