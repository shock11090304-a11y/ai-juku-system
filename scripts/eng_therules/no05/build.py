...
def build_mondai():
    ...
    h += '</div>'
    h += foot("問題編")
    return doc("英語長文 The Rules 式 No.05 問題編", h)
...
def svg_fig1():
    ...
    <text x="80" y="103" fill="#fff" font-size="15" font-weight="700" text-anchor="middle">歴　史</text>
    <text x="80" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">history</text>
    ...
    <text x="347" y="42" fill="#b91c1c" font-size="12" font-weight="700" text-anchor="middle">暗記科目として扱う</text>
    <text x="347" y="60" fill="#7f1d1d" font-size="10" text-anchor="middle">年号・人名の想起（通念）</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">問い方の訓練として扱う</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">証拠から説明を組み立てる</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">検索に勝てない</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">無意味・退屈に見える</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">価値はむしろ増す</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">検索の時代にこそ効く（第7段）</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">歴史が鍛える習慣</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">the habits of mind</text>
    ...
    <text x="335" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 因果をたどる訓練</text>
    <text x="335" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">断片の証拠→説明（第3〜4段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 現在の相対化</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">当たり前にも歴史がある（第5段）</text>
    ...
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">説明を鵜呑みにせず、検証する</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">test, not swallow whole</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">「今の世界も変えられる」と知る</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">what was built can be rebuilt</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="82" fill="#b91c1c" font-size="14" font-weight="700" text-anchor="middle">歴史 ＝ 暗記科目？</text>
    <text x="130" y="104" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ 検索できるから覚える意味なし</text>
    ...
    <text x="510" y="70" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">過去の記録というより「現在を読むレンズ」</text>
    <text x="510" y="92" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 核心は事実の所有ではなく〈問いの立て方〉</text>
    <text x="510" y="112" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not so much a record of the past as a lens</text>
    <text x="510" y="130" fill="#64748b" font-size="9" text-anchor="middle">事実は骨組みとして使いつつ——検索の時代こそ問い方の価値は増す</text>
  </svg>"""
...
def build_kaisetsu():
    ...
    # --- 全訳 ---
    h += '<div class="section pb"><div class="secttl">全訳<span class="en2">Translation</span></div>'
    ...
    return doc("英語長文 The Rules 式 No.05 解説編", h)
