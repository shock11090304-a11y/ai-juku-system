...
def svg_fig1():
    ...
    <text x="85" y="103" fill="#fff" font-size="15" font-weight="700" text-anchor="middle">二種類の勉強</text>
    <text x="85" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">two kinds of study</text>
    ...
    <text x="347" y="42" fill="#334155" font-size="12" font-weight="700" text-anchor="middle">単純作業</text>
    <text x="347" y="60" fill="#475569" font-size="10" text-anchor="middle">カード整理・書き写し（第2段）</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">ことばの勉強</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">読解・英作文・暗記（第3段）</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">音楽は味方になる</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">気分が上がり、手が動き続ける</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">歌詞と頭の取り合い</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">読み直し増・残りにくい（第4段）</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="13" font-weight="700" text-anchor="middle">歌詞つき音楽の問題</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">songs with lyrics</text>
    ...
    <text x="335" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① ことばの取り合い</text>
    <text x="335" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">同じ行を読み直す（第4段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② はかどり錯覚</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">a false sense of progress（第5段）</text>
    ...
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">内容が記憶に残りにくい</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">remember less（第4段）</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">感覚と結果は別物</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">feeling ≠ result（第5段）</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="76" fill="#b91c1c" font-size="13" font-weight="700" text-anchor="middle">音楽 ＝ 敵か、味方か？</text>
    <text x="130" y="98" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ どちらか一方に決めつける</text>
    ...
    <text x="510" y="68" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">音楽 ＝ 使い分ける道具</text>
    <text x="510" y="90" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 休憩・単純作業では使い、ことばの勉強では止める</text>
    <text x="510" y="110" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not an enemy or a friend but a tool</text>
    <text x="360" y="148" fill="#64748b" font-size="9" text-anchor="middle">前提：音楽を捨てろという話ではない——「いつ使い、いつ止めるか」を知ることが答え（第6〜7段）</text>
  </svg>"""
