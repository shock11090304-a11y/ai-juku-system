...
def svg_fig1():
    ...
    <text x="85" y="103" fill="#fff" font-size="15" font-weight="700" text-anchor="middle">二種類の本</text>
    <text x="85" y="120" fill="#cbd5e1" font-size="10" text-anchor="middle">two kinds of books</text>
    ...
    <text x="347" y="42" fill="#334155" font-size="12" font-weight="700" text-anchor="middle">実用書・教科書</text>
    <text x="347" y="60" fill="#475569" font-size="10" text-anchor="middle">速い・便利・整った知識（第2段）</text>
    <rect x="255" y="138" width="185" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="347" y="158" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">物語・小説</text>
    <text x="347" y="176" fill="#1e3a8a" font-size="10" text-anchor="middle">他人の頭の中を生きる（第3段）</text>
    ...
    <text x="612" y="44" fill="#475569" font-size="11.5" font-weight="700" text-anchor="middle">頭を知識で満たす</text>
    <text x="612" y="61" fill="#64748b" font-size="9.5" text-anchor="middle">事実・技能が手に入る</text>
    <rect x="525" y="140" width="175" height="48" rx="9" fill="#eff6ff" stroke="#1d4ed8"/>
    <text x="612" y="160" fill="#1e40af" font-size="11.5" font-weight="700" text-anchor="middle">心を他人へ伸ばす</text>
    <text x="612" y="177" fill="#1e3a8a" font-size="9.5" text-anchor="middle">想像する力が育つ（第7段）</text>
  </svg>"""
...
def svg_fig2():
    ...
    <text x="95" y="105" fill="#fff" font-size="14" font-weight="700" text-anchor="middle">物語がくれる練習</text>
    <text x="95" y="122" fill="#c7d2fe" font-size="9.5" text-anchor="middle">practice in fiction</text>
    ...
    <text x="335" y="37" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">① 人物として生きる</text>
    <text x="335" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">feel, judge, choose（第4段）</text>
    <rect x="250" y="146" width="170" height="52" rx="9" fill="#dbeafe" stroke="#1d4ed8"/>
    <text x="335" y="167" fill="#1e40af" font-size="12" font-weight="700" text-anchor="middle">② 気持ちを想像する</text>
    <text x="335" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">imagine hidden feelings（第5段）</text>
    ...
    <text x="587" y="38" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">他人の人生を安全に「試着」する</text>
    <text x="587" y="55" fill="#1e3a8a" font-size="9.5" text-anchor="middle">trying on another life（第4段）</text>
    <rect x="475" y="148" width="225" height="48" rx="9" fill="#eff6ff" stroke="#93c5fd"/>
    <text x="587" y="168" fill="#1e40af" font-size="11" font-weight="700" text-anchor="middle">友人関係・仕事の土台になる</text>
    <text x="587" y="185" fill="#1e3a8a" font-size="9.5" text-anchor="middle">a base for friendship and work（第5段）</text>
  </svg>"""
...
def svg_fig3():
    ...
    <text x="130" y="76" fill="#b91c1c" font-size="13" font-weight="700" text-anchor="middle">物語 ＝ 現実からの逃避？</text>
    <text x="130" y="98" fill="#7f1d1d" font-size="10.5" text-anchor="middle">✗ 娯楽にすぎず役に立たない</text>
    ...
    <text x="510" y="68" fill="#1e40af" font-size="14" font-weight="700" text-anchor="middle">物語 ＝ 現実のための練習</text>
    <text x="510" y="90" fill="#1e3a8a" font-size="10.5" text-anchor="middle">○ 他人の頭の中を生き、見えない気持ちを想像する力を鍛える</text>
    <text x="510" y="110" fill="#1e3a8a" font-size="10.5" text-anchor="middle">not an escape from real life but practice for it</text>
    <text x="360" y="148" fill="#64748b" font-size="9" text-anchor="middle">前提：実用書が不要という話ではない——二つは競争相手ではなく役割が違うだけ（第7段）</text>
  </svg>"""
