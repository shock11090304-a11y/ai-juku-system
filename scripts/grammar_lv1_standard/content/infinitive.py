...
QUESTIONS = [
    # ---------------- mc ----------------
    {
        ...
        "explanation": "live は自動詞なので「~に住む」には前置詞 in が必要で、live in a house の形がもとになっている。"
                       ...
                       "to live では前置詞が抜けており、living にすると house が「住んでいる」ことになり、修飾する語と名詞の関係が逆になる。to be lived は受動で「住まれる家」となり不自然。",
    ...
    },
    {
        ...
        "explanation": "difficult は事柄の難易を表す形容詞なので、不定詞の意味上の主語は for + 人で表し for him になる。"
                       ...
                       "to him は不定詞の意味上の主語を示す形ではなく、that he は後ろが節になる形なので to solve と続けられない。",
    ...
    },
    {
        ...
        "explanation": "To tell the truth は「実を言うと」という意味の独立不定詞で、文全体に話し手の態度を添える決まった形。"
                       "Told は受動の意味になり、主語 I が「告げられる」側になってしまう。"
                       "Telling は分詞構文としては作れるが「真実を語りながら反対する」という意味になり、前置きとして文全体に態度を添える働きにならない。To be told も受動なので the truth を目的語にとれない。",
