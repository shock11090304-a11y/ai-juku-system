...
QUESTIONS = [
    ...
    {
        "type": "order", "level": "advanced",
        "prompt_ja": "もっと早く出発していれば、私たちは今ごろ東京にいるのに。",
        "answer": "If we had left earlier, we would be in Tokyo now.",
        "explanation": "出発は過去のことなので if 節は had left、結果は now が示す現在のことなので主節は would be にする。"
                       "このように条件と結果で時がずれるのが混合仮定法で、主節に would have been を使うと現在の結果にならない。"
                       "大文字で始まる If が文頭、コンマの付いた earlier, が前半の切れ目、now が文末になるため語順は一つに定まる。",
        "point": "混合仮定法は if 節が過去・主節が現在",
    },
    {
        "type": "order", "level": "advanced",
        "prompt_ja": "もし私があなたなら、その申し出は断るだろう。",
        "answer": "Were I you, I would turn down the offer.",
        "explanation": "If I were you から if を省略すると、be 動詞が主語の前に出て Were I you となる。"
                       "主節は仮定法過去の結果なので would + 動詞の原形にする。"
                       "大文字で始まる Were が文頭、コンマの付いた you, が前半の切れ目、offer が文末になるため語順は一つに定まる。",
