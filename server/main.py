...
# 1期生100名永年¥25,000 (Stripe ダッシュボードで作成して env に設定)
STRIPE_PRICE_FOUNDER1 = os.getenv("STRIPE_PRICE_FOUNDER1", "price_founder1_placeholder")
...
PRICE_MAP = {
    # 1期生100名限定 永年¥25,000
    "founder1": (STRIPE_PRICE_FOUNDER1, 25000, "1期生 (永年¥25,000)", 1),
...
def create_trial_checkout(payload: dict):
    ...
    第1期生100名枠は本契約 (paid) のみでカウント。体験は無制限に受付。
    """
