...
const TB_UNITS_BY_SUBJECT = {
  '英語（英検準1級）': ['単語強化 (Part1)', 'リーディング (Part2 長文)', 'リスニング Part1 (会話)', 'リスニング Part2 (文章)', 'ライティング (意見記述)', '英作文 (120-150語)', '二次面接対策', '過去問演習'],
  '英語（英検2級）': ['単語 (2600語)', 'リーディング', 'ライティング (エッセイ)', 'リスニング', '面接 (質問応答)', '過去問演習'],
  ...
  '数学Ⅲ': ['複素数平面', '式と曲線', '極限', '関数と極限', '微分法 (数III)', '微分の応用', '積分法 (数III)', '積分の応用', '面積・体積', '媒介変数表示'],
