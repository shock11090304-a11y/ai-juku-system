...
(function() {
  ...
  const ME_KUBUN = {
    ...
    '共通テスト型': ['共通テスト'],
    // 2026-06-03 中学生モード Phase0: 高校受験/中学受験 区分 (target_grade=中学生/小学生 のコンテンツ)
    '高校受験': ['公立高校入試', '私立高校入試', '難関国私立高校'],
    '中学受験': ['中学受験'],
  };
  const ME_KUBUN_ORDER = ['旧帝大', '難関国公立', '中堅国公立', '私大', '共通テスト型', '高校受験', '中学受験', 'その他'];
