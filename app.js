...
function buildDemoChat(userMsg, systemPrompt) {
  ...
  // 社会（日本史・世界史）
  if (/日本史|世界史|歴史|政治経済|地理/.test(subject + text)) {
...
async function getSpeakingFeedback(transcript) {
  ...
  const systemPrompt = `You are an expert English speaking coach for Japanese students. Evaluate the student's spoken response and provide detailed feedback.
...
Please evaluate and provide detailed feedback in Japanese.`;
